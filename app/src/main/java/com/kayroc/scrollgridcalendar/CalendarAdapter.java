...
import com.kayroc.scrollcalendarlib.utils.LunarCalendar;
...
//	private static String week[] = {"周日","周一","周二","周三","周四","周五","周六"};
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position < daysOfMonth + dayOfWeek && position >= dayOfWeek) {
			...
			// 设置 选中的背景
			if (CalendarUtils.zYear.equals(currentYear) && CalendarUtils.zMonth.equals(currentMonth) && CalendarUtils.zDay.equals(mDay)){
				...
				textView.setTextColor(Color.WHITE);
			} else if (!CalendarUtils.zMonth.equals(currentMonth) && mJumpMonth != 0 && "1".equals(mDay)){
